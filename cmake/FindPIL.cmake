...
if(NOT PIL_FIND_VERSION)
  ...
  set(PIL_FIND_VERSION "${PIL_FIND_VERSION_MAJOR}.${PIL_FIND_VERSION_MINOR}.${PIL_FIND_VERSION_PATCH}")
...
FIND_PATH( PIL_INCLUDE_DIR base/PIL_VERSION.h
	...
	$ENV{PIL_HOME}/src
	# system placed in 
	/usr/local/include/pil
	C:/Qt/PIL/include/pil
)

if(PIL_INCLUDE_DIR)
	pil_check_version()
	set(PIL_INCLUDES ${PIL_PATH}/include ${PIL_INCLUDE_DIR})
...
if(WIN32)
	if( PIL_VERSION_OK )
		...
		# MINGW
		if(MINGW)
			SET(PIL_LIBRARY_DIR ${PIL_PATH}/lib/)
			file(GLOB PIL_LIBRARIES "${PIL_LIBRARY_DIR}/*.dll.a")
		endif(MINGW)
