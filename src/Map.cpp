...
void Map::Run(void)
{
    ...
    while( true ) {

        {
            ...
            ClearUnusedMapPoint(GSLAM::TicToc::timestamp());
        }
        ...
        {
            boost::mutex::scoped_lock lock(mMutexMap);
            ClearUnusedKeyFrame(GSLAM::TicToc::timestamp());
        }
...
void Map::EraseMapPoint(MapPoint *pMP)
{
    ...
    pMP->setBadTS(GSLAM::TicToc::timestamp());
...
void Map::EraseKeyFrame(KeyFrame *pKF)
{
    ...
    pKF->setBadTS(GSLAM::TicToc::timestamp());
